...
describe('REDUCER for tableData', () => {
   ...
   it('should handle "SUCCESS_TABLE_DATA" action', () => {
    expect(reducer({}, { type: 'SUCCESS_TABLE_DATA', payload })).toEqual({...initialState, tableData: {...initialState.tableData, fetched: true, data: payload.data.data}})
   })

   it('should handle "ERROR_TABLE_DATA" action', () => {
    expect(reducer({}, { type: 'ERROR_TABLE_DATA', payload: errorPayload })).toEqual({...initialState, tableData: {...initialState.tableData, fetched: true, errorMsg: 'Couldn\'t Fetch Data', error: errorPayload.error}})
   })
